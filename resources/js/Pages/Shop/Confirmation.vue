    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-lg mx-auto px-4 sm:px-6 py-10 sm:py-16">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex h-20 w-20 items-center justify-center rounded-full bg-green-100 mb-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100">
                    ...
                    <div class="space-y-3">
                        <div v-for="item in order.line_items" :key="item.id" class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg overflow-hidden flex-none bg-gray-100">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xl font-bold text-green-700">{{ formatCurrency(order.total) }}</span>
                    </div>

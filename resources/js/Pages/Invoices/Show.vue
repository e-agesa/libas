            ...
            <form @submit.prevent="submitPayment" class="p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input v-model="paymentForm.amount" type="number" min="0.01" :max="invoice.balance" step="any" required class="w-full rounded-md border-gray-300 text-sm focus:border-brand-600 focus:ring-brand-600" :placeholder="`Max: ${Number(invoice.balance).toLocaleString()}`" />
